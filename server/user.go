...
func NewUserServer(s *Server) api.UserServer {
	return &userServer{
		logger: s.Logger,
		dex:    s.Dex,
	}
...
func (s userServer) SignUp(ctx context.Context, req *api.SignUpReq) (*api.SignUpRes, error) {
...
// SignIn ..
func (s userServer) SignIn(ctx context.Context, req *api.SignInReq) (*api.SignInRes, error) {
