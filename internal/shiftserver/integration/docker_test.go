...
// 	if err != nil {
// 		t.Log(fmt.Sprintf("failed to start the container: %v", err))
// 	}

// 	statusCh, err := cli.CLI().ContainerWait(ctx, containerID)
// 	if err != nil {
// 		t.Log(fmt.Sprintf("failed to wait for container: %v", err))
// 	}
// 	fmt.Println("Statuscode: ", statusCh)
