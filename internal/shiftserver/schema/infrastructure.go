...
import (
	...
	"gitlab.com/conspico/elasticshift/internal/shiftserver/infrastructure"
	"gitlab.com/conspico/elasticshift/internal/pkg/utils"
)

func newInfrastructureSchema(ctx context.Context, logger logrus.Logger, s store.Shift) (queries graphql.Fields, mutations graphql.Fields) {

	r, _ := infrastructure.NewResolver(ctx, logger, s)
