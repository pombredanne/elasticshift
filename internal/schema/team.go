...
import (
	...
	"gitlab.com/conspico/elasticshift/internal/pkg/team"
	"gitlab.com/conspico/elasticshift/internal/store"
)

func newTeamSchema(ctx context.Context, logger logrus.Logger, s store.Shift) (queries graphql.Fields, mutations graphql.Fields) {

	r, _ := team.NewResolver(ctx, logger, s)
